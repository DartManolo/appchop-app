  ...
  Future<void> agregarClienteDirectorio() async {
    await Permission.contacts.isDenied.then((denegado) async {
      if (denegado) {
        ...
        try {
          var contactPicker = FlutterNativeContactPicker();
          var contact = await contactPicker.selectContact();
          nombre.text = contact!.fullName!;
          telefono.text = contact.phoneNumbers![0].replaceAll(" ", "");
        } catch(e) {
